...
exports.approveClaim = async (req, res) => {
  try {
    ...
    // notificationService rather than a bare email: it records an in-app
    // notification as well, so the approval is visible when they next sign in
    // even if the message never reaches their inbox.
