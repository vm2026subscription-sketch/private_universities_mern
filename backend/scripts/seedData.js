...
const universities = [
  ...
  { name: "Amrutvahini College of Engineering (AVCOE)", state: "Maharashtra", city: "Sangamner", type: "private", establishedYear: 1983, naacGrade: "A+", nirfRank: null, description: "Amrutvahini College of Engineering, Sangamner is an autonomous institute affiliated to Savitribai Phule Pune University. NAAC A+ graded with 3.40 CGPA, 4-time NBA accredited, and winner of Best College Award by SPPU.", website: "https://www.avcoe.org", approvals: { ugc: true, aicte: true, nmc: false, bci: false, coa: false, pci: false }, stats: { totalStudents: 4000, campusSizeAcres: 16, avgPackageLPA: 4.2, highestPackageLPA: 8.8, placementPercentage: 85 }, topRecruiters: ["TDK", "Mahindra & Mahindra", "Tetra Pak", "Epitome", "Jerai Fitness", "ABB", "KSB"], facilities: ["Library", "Hostel", "Sports Complex", "Cafeteria", "Labs", "WiFi", "Gymkhana", "Transport"], address: "Sangamner, Dist. Ahilyanagar, Maharashtra - 422608", phone: "+91-2425-259096", email: "principal@avcoe.org" }
];
