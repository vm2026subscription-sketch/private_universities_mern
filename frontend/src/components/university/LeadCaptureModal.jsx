...
export default function LeadCaptureModal({ isOpen, onClose, university, leadType = 'apply', onSuccess }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal box */}
      <div className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-3xl bg-white dark:bg-dark-card border border-light-border dark:border-dark-border shadow-lg transition-all duration-300 transform scale-100 z-10">
