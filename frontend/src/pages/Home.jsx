    ...
    <div className="bg-[#f8fafc] dark:bg-dark-bg min-h-screen pb-20 overflow-x-hidden">
      ...
      <section className="relative h-[600px] md:h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-20 -mt-16">
          ...
          >
            <h1 className="text-4xl md:text-7xl font-black mb-6 tracking-tight text-white drop-shadow-lg leading-tight">
              India's Most Trusted <br />
              <span className="text-primary">University Portal</span>
            </h1>
            <p className="text-white/85 mb-10 text-lg md:text-2xl max-w-2xl mx-auto font-medium">
              Find the perfect campus from 700+ top-rated institutions.
            </p>

            <form onSubmit={handleSearch} className="relative max-w-2xl mx-auto">
              <div className="relative flex shadow-2xl rounded-2xl overflow-hidden bg-white border-2 border-white/30">
                <div className="flex items-center px-6 text-slate-400">
                ...
                <input
                  ...
                  placeholder="Search Thakur, Amity, SAGE, or any university..."
                  className="w-full py-5 bg-transparent text-slate-900 text-lg font-semibold placeholder:text-slate-400 focus:outline-none"
                />
                <button type="submit" className="bg-primary hover:bg-primary/90 text-white px-10 font-black text-base transition-all whitespace-nowrap">
                  Search
                </button>
              </div>
            </form>
      ...
      <section className="max-w-7xl mx-auto px-4 -mt-16 relative z-30">
        <div className="bg-white dark:bg-dark-card shadow-2xl rounded-[2.5rem] p-8 md:p-10 flex flex-wrap justify-between gap-8 border border-slate-100 dark:border-white/5">
          {stats.map((s, i) => (
            <div key={i} className="flex items-center gap-4 flex-1 min-w-[150px] justify-center md:justify-start">
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {[
            { icon: ShieldCheck, title: '100% Verified Data', desc: 'Directly sourced from university administration.' },
            { icon: FileDown, title: 'One-Click Brochures', desc: 'Download official prospectuses instantly.' },
            { icon: Sparkles, title: 'AI Admission Guide', desc: 'Get personalized college recommendations.' },
            { icon: PhoneCall, title: 'Direct Campus Connect', desc: 'Speak directly with admission officers.' },
          ].map((item, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, y: 20 }}
              ...
              viewport={{ once: true }}
              className="p-8 bg-white dark:bg-dark-card rounded-[2rem] border border-slate-100 dark:border-white/5 shadow-xl hover:shadow-primary/10 hover:border-primary/20 transition-all group text-center"
            >
              ...
              <h4 className="font-black text-lg mb-3 text-slate-900 dark:text-white">{item.title}</h4>
      ...
      {/* Top Recruiters */}
      <section className="max-w-7xl mx-auto px-4 py-12">
        <p className="text-center text-xs font-black text-slate-400 uppercase tracking-[0.2em] mb-8">Top Companies Hiring from our Partners</p>
        <div className="flex flex-wrap justify-center items-center gap-10 md:gap-20 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-700">
          {['Google', 'Microsoft', 'Amazon', 'TCS', 'Infosys', 'Accenture'].map((c) => (
            <span key={c} className="text-2xl font-black text-slate-400">{c}</span>
          ))}
        </div>
      </section>
        ...
        >
          {mainStreams.map((stream, i) => (
            <motion.div key={i} variants={itemVariants}>
              <Link to={`/courses?category=${stream.name}`} className="flex flex-col items-center text-center group">
                <div className={`w-16 h-16 rounded-2xl ${stream.bg} dark:bg-slate-800/50 flex items-center justify-center mb-4 shadow-sm group-hover:shadow-lg transition-all duration-300`}>
                  <stream.icon className={`w-8 h-8 ${stream.color}`} />
                </div>
                <p className="text-xs md:text-sm font-bold text-slate-700 dark:text-slate-300 group-hover:text-primary transition-colors uppercase">{stream.name}</p>
              </Link>
            </motion.div>
          ))}
        </motion.div>
      ...
      <motion.div
        ...
        className="fixed left-0 top-1/2 -translate-y-1/2 z-[60] bg-primary text-white py-4 px-2 rounded-r-xl cursor-pointer shadow-2xl hover:pl-4 transition-all group"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <motion.div whileHover={{ y: -5 }} className="relative overflow-hidden p-6 rounded-[2rem] bg-gradient-to-br from-indigo-600 to-indigo-800 text-white shadow-xl group">
                <div className="relative z-10">
                  <span className="bg-white/20 text-[10px] font-black px-3 py-1 rounded-full uppercase">Maharashtra State</span>
                  <h3 className="font-black text-2xl mt-4 mb-2">DTE Admissions 2024-25</h3>
                  <p className="text-sm text-white/80 mb-6">Complete guide to Engineering, Pharmacy & MBA admissions.</p>
                  <button className="w-full bg-white text-indigo-600 font-black py-3 rounded-2xl text-sm transition-all hover:shadow-2xl">
                    View Updates
                  </button>
                </div>
              </motion.div>
              ...
              <motion.div whileHover={{ y: -5 }} className="relative overflow-hidden p-6 rounded-[2rem] bg-gradient-to-br from-primary to-orange-500 text-white shadow-xl group">
                <div className="relative z-10">
                  <span className="bg-white/20 text-[10px] font-black px-3 py-1 rounded-full uppercase">Tool</span>
                  <h3 className="font-black text-2xl mt-4 mb-2">Rank Predictor</h3>
                  <p className="text-sm text-white/80 mb-6">Predict your college based on MHT-CET, JEE & NEET scores.</p>
                  <button className="w-full bg-white text-primary font-black py-3 rounded-2xl text-sm transition-all hover:shadow-2xl">
                    Predict Now
                  </button>
                </div>
              </motion.div>
              ...
              <motion.div whileHover={{ y: -5 }} className="relative overflow-hidden p-6 rounded-[2rem] bg-slate-900 text-white shadow-xl group border border-white/10">
                <div className="relative z-10">
                  <span className="bg-primary text-[10px] font-black px-3 py-1 rounded-full uppercase text-white">Private Unis</span>
                  <h3 className="font-black text-2xl mt-4 mb-2">PERA CET 2026</h3>
                  <p className="text-sm text-white/80 mb-6">Entrance for 15+ top private universities in Maharashtra.</p>
                  <button className="w-full bg-primary text-white font-black py-3 rounded-2xl text-sm transition-all hover:shadow-2xl">
                    Apply Now
                  </button>
                </div>
              </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {(universities.length > 0 ? universities : mockUniversities).map((u, i) => (
                <motion.div key={i} whileHover={{ y: -5 }}>
                  <Link to={`/universities/${u._id}`} className="group relative bg-white dark:bg-dark-card p-6 rounded-[2rem] border border-slate-100 dark:border-white/5 hover:border-primary hover:shadow-2xl transition-all flex gap-6 items-center">
                    <div className="w-24 h-24 bg-white rounded-2xl shadow-sm flex items-center justify-center overflow-hidden border border-slate-50 p-2 shrink-0">
                      {(u.logoUrl || u.logo) ? (
                        <img
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start">
                        <h3 className="font-black text-lg line-clamp-1 group-hover:text-primary transition-colors">{u.name}</h3>
                        <div className="flex items-center gap-1 bg-green-50 text-green-600 px-2 py-0.5 rounded-full text-[10px] font-bold">
                      ...
                      <div className="flex items-center gap-6">
                        <div>
                          <p className="text-[10px] text-slate-400 uppercase font-black tracking-widest">Avg Package</p>
                          <p className="text-sm font-black text-slate-900 dark:text-white">₹{u.stats?.avgPackageLPA || '4.5'} LPA</p>
                        </div>
                        <div>
                          <p className="text-[10px] text-slate-400 uppercase font-black tracking-widest">Courses</p>
                          <p className="text-sm font-black text-slate-900 dark:text-white">{u.stats?.totalCoursesCount || 12}+</p>
                        </div>
                      </div>
                    </div>
