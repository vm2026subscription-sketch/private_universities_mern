    ...
    <div className="bg-[#f8fafc] dark:bg-dark-bg min-h-screen pb-20 overflow-x-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {[
            { name: 'Maharashtra', count: '150+ Colleges', img: null, landmark: 'Mumbai Skyline', color: 'from-blue-900 to-blue-700' },
            ...
            { name: 'Rajasthan', count: '120+ Colleges', img: null, landmark: 'Amber Fort', color: 'from-yellow-900 to-yellow-700' },
            ...
            { name: 'Chhattisgarh', count: '60+ Colleges', img: null, landmark: 'Chitrakote Falls', color: 'from-green-900 to-green-700' },
          ].map((state, i) => (
            <motion.div
              key={i}
              whileHover={{ y: -5 }}
